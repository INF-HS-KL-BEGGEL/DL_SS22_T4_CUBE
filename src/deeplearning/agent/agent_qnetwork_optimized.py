...
class QNetworkAgentOptimizdOLD(Agent):
    ...
    def __init__(self, environment, optimizer=Adam(learning_rate=0.01), epsilon=0.2, gamma=0.9, timesteps_per_episode=10):
        ...
        self.experience_replay = collections.deque(maxlen=timesteps_per_episode*4)
    ...
    def retrain(self, batch_size):
        ...
        # Generate arg maxes for predictions
        q_model.fit(states, target, epochs=4, steps_per_epoch=batch_size, verbose=0)
